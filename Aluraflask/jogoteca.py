...
jogo1 = Jogo("Super Mario World", "Plataforma", "SNES")
jogo2 = Jogo("Pokemon Gold", "RPG", "GBC")
...
usuario3 =Usuario("Flavio","Flavio Corrupto", "Javascript")
